          ...
          <div
              ...
              <div className="max-w-sm rounded-xl border bg-white border-purple-400 mt-2">
                ...
                <div className='py-2 px-1 flex gap-2'>
                  <svg width="51" height="40" viewBox="0 0 51 40" fill="none" xmlns="http://www.w3.org/2000/svg" className=''>
                    <rect width="51" height="40" rx="2.13" fill="white"/>
                    <rect x="0.5" y="0.5" width="50" height="39" rx="1.63" stroke="#9DADBC" strokeOpacity="0.36"/>
